...
public class GenieSearchAPIConfig {
	...
	private static void logConfigStatus() {
		...
		if(!"crawled-projects".equals(getCrawledProjectsPath().getFileName()+"")) {
			...
			LogUtils.getLogger().error("A pasta dos códigos-fonte do repositório precisa chamar-se 'crawled-projects' no arquivo de propriedades: " + ClassLoader.getSystemResource("") + configFileName);
